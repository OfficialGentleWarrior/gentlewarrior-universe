...
window.RESPONSES_INFO_CP = {
  ...
  types: (lang) => ({
    text: lang === "en"
  ? "There are different types of CP — would you like a short list, or to learn about their differences?"
  ...
  short_list: (lang) => ({
    text: lang === "en"
      ? "The main types are spastic, dyskinetic, ataxic, and mixed CP — do you want to learn about their differences or how therapy helps?"
